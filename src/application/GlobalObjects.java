...
public class GlobalObjects {
	...
	public static EffortLog effort1 = new EffortLog("Problem Understanding", "Plans", "ProjectPlan", 10,"yyyy-MM-dd HH:mm:ss");
	public static EffortLog effort2 = new EffortLog("Conceptual Design Plan", "Deliverables", "Conceptual Design", 3,"yyyy-MM-dd HH:mm:ss");
	public static EffortLog effort3 = new EffortLog("Implementation Plan", "Defects", "Documentation", 5,"yyyy-MM-dd HH:mm:ss");
	public static EffortLog effort4 = new EffortLog("Solution Review", "Deliverables", "Implementation Plan", 2,"yyyy-MM-dd HH:mm:ss");
	public static EffortLog effort5 = new EffortLog("Unit/System Test", "Interruptions", "ProjectPlan", 4,"yyyy-MM-dd HH:mm:ss");
	public static EffortLog effort6 = new EffortLog("Repository Update", "Other", "Refactor", 1,"yyyy-MM-dd HH:mm:ss");
